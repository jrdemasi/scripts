...
/var/tmp/gh_create.py https://raw.githubusercontent.com/jrdemasi/scripts/master/rmghc2018/container-users.txt

# Create a cronjob to run gh_create.py every 5 minutes:
echo "*/5 * * * * root /var/tmp/gh_create.py https://raw.githubusercontent.com/jrdemasi/scripts/master/rmghc2018/container-users.txt" > /etc/cron.d/gh_create
